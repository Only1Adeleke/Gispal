/**
 *getProcessedFileCount.js
 */

const response = require('../../utils/response');

/**
 * @description : returns total number of records of ProcessedFile
...
const getProcessedFileCount = ({
  ...
  let count = await ProcessedFileDb.count(where);
  return response.success({ data:{ count } });
};
module.exports = getProcessedFileCount;