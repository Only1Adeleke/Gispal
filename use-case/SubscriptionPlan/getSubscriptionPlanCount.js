/**
 *getSubscriptionPlanCount.js
 */

const response = require('../../utils/response');

/**
 * @description : returns total number of records of SubscriptionPlan
...
const getSubscriptionPlanCount = ({
  ...
  let count = await SubscriptionPlanDb.count(where);
  return response.success({ data:{ count } });
};
module.exports = getSubscriptionPlanCount;