/**
 *getVideoSourceCount.js
 */

const response = require('../../utils/response');

/**
 * @description : returns total number of records of VideoSource
...
const getVideoSourceCount = ({
  ...
  let count = await VideoSourceDb.count(where);
  return response.success({ data:{ count } });
};
module.exports = getVideoSourceCount;