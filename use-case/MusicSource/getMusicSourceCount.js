/**
 *getMusicSourceCount.js
 */

const response = require('../../utils/response');

/**
 * @description : returns total number of records of MusicSource
...
const getMusicSourceCount = ({
  ...
  let count = await MusicSourceDb.count(where);
  return response.success({ data:{ count } });
};
module.exports = getMusicSourceCount;